...
class Game{
    ...
    startGame(){
        ...
        //plain and obstacles back to the start
        this.plane.reset();
    ...
    incScore(){
        //method to increase a score when coins are collected
        this.score++;
	...
	render() {
        ...
        //if game is active we call update method, it needs plane's worlds position, so it knows if it collects coins or if it's a bomb
